...
<dialog
  ...
  class="fixed m-0 max-h-[calc(100dvh-2rem)] max-w-[calc(100vw-2rem)] overflow-y-auto overscroll-contain rounded-md border border-line-strong bg-surface p-0 text-fg shadow-md outline-none backdrop:bg-overlay"
